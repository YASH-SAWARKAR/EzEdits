...
const FeatureCard = ({ icon, title, description }) => {
  return (
    <div
      className={`backdrop-blur-lg  border border-white/10 rounded-2xl p-8 transition-all duration-700 cursor-pointer }`}
    >
  ...
  return (
    <section className="py-20" id="features">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <CardSpotlight className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
